...
const useStyles = makeStyles(theme => ({
  ...
  image: {
    backgroundImage: 'url("https://images.unsplash.com/photo-1492515114975-b062d1a270ae?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2100&q=80")',
